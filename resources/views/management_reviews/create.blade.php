    ...
    <div class="row">
        ...
        <div class="col-md-10 main">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Add Management Review </li>
                </ol>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                {{Form::text('meeting_name', '', ['class' => 'form-control'])}}
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        {{Form::text('action_plan_test', '', ['class' => 'form-control', 'id' => 'action_plan_test', 'disabled'])}}
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        {{Form::text('agenda_memo_text', '', ['class' => 'form-control', 'id' => 'agenda_memo_text', 'disabled'])}}
                                    </div>
                                    <div class="col-md-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        {{Form::text('minutes_text', '', ['class' => 'form-control', 'id' => 'minutes_text', 'disabled'])}}
                                    </div>
                                    <div class="col-md-4">
